...
export const PHASE1_REASONING = 'low';
export const PHASE2_REASONING = 'medium';
 ...
 */
export async function resolveStageRoute(runtime, route, target, signal) {
    ...
    if (exact !== undefined)
        return { ...route, reasoningEffort: exact.id };
